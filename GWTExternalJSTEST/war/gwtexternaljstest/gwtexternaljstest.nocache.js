function gwtexternaljstest(){
  ...
  gwtexternaljstest.__sendStats = sendStats;
  gwtexternaljstest.__moduleName = $intern_4;
  gwtexternaljstest.__errFn = null;
  gwtexternaljstest.__moduleBase = $intern_6;
  gwtexternaljstest.__softPermutationId = $intern_7;
  gwtexternaljstest.__computePropValue = null;
  gwtexternaljstest.__getPropMap = null;
  gwtexternaljstest.__installRunAsyncCode = function(){
  }
  ;
  gwtexternaljstest.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  gwtexternaljstest.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  gwtexternaljstest.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  gwtexternaljstest.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[gwtexternaljstest.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (gwtexternaljstest.__errFn) {
        script.onerror = function(){
          gwtexternaljstest.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  gwtexternaljstest.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  gwtexternaljstest.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    gwtexternaljstest.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return gwtexternaljstest.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    gwtexternaljstest.__getPropMap = function(){
      var result = {};
    ...
    ;
    gwtexternaljstest.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = gwtexternaljstest.__getPropMap;
    ...
    gwtexternaljstest.__softPermutationId = softPermutationId;
  ...
  processMetas();
  gwtexternaljstest.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = gwtexternaljstest.__moduleBase;
...
gwtexternaljstest.succeeded = gwtexternaljstest();
